...
class GHActionsProxy:
    ...
    def __init__(self):
        ...
        map = {
            ...
            (
                "PUT",
                "/repositories/{id}/pulls/{pull_number}/merge",
                "contents",
                "write",
            ),
            (
            ...
            (
                "PUT",
                "/repositories/{id}/pulls/{pull_number}/update-branch",
                "contents",
                "write",
            ),
            (
            ...
            (
                "POST",
                "/repositories/{id}/comments/{comment_id}/reactions",
                "contents",
                "write",
            ),
            (
            ...
            (
                "DELETE",
                "/repositories/{id}/comments/{comment_id}/reactions/{reaction_id}",
                "contents",
                "write",
            ),
            ...
            (
                "POST",
                "/repositories/{id}/issues/{issue_number}/assignees",
                "issues/pull-requests",
                "write",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/issues/{issue_number}/comments",
                "issues/pull-requests",
                "read",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/issues/comments",
                "issues,pull-requests",
                "read",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/issues/comments/{comment_id}",
                "issues/pull-requests",
                "read",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/issues/{issue_number}/events",
                "issues/pull-requests",
                "read",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/issues/events/{event_id}",
                "issues/pull-requests",
                "read",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/issues/{issue_number}/timeline",
                "issues/pull-requests",
                "read",
            ),
            ...
            (
                "GET",
                "/repositories/{id}/issues/{issue_number}",
                "issues/pull-requests",
                "read",
            ),
            (
            ...
            (
                "PUT",
                "/repositories/{id}/issues/{issue_number}/lock",
                "issues/pull-requests",
                "write",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/issues/{issue_number}/labels",
                "issues/pull-requests",
                "read",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/milestones/{milestone_number}/labels",
                "issues",
                "read",
            ),
            ...
            (
                "GET",
                "/repositories/{id}/milestones/{milestone_number}",
                "issues",
                "read",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/issues/{issue_number}/reactions",
                "issues/pull-requests",
                "read",
            ),
            (
            ...
            (
                "DELETE",
                "/repositories/{id}/issues/{issue_number}/reactions/{reaction_id}",
                "issues/pull-requests",
                "write",
            ),
            (
            ...
            (
                "GET",
                "/repositories/{id}/issues/comments/{comment_id}/reactions",
                "issues/pull-requests",
                "read",
            ),
            (
            ...
            (
                "DELETE",
                "/repositories/{id}/issues/{issue_number}/labels/{name}",
                "issues/pull-requests",
                "write",
            ),
    ...
    def get_permission(self, path, method, query):
        ...
        if len(path_segments) >= 3:
            if path_segments[1] == "repos" and not self.same_repository(
                path_segments[2], path_segments[3]
            ):
                return []
        elif len(path_segments) >= 2:
            if path_segments[1] == "repositories" and not self.same_repository(
                path_segments[2]
            ):
                return []
        ...
        if node:
            ...
            if (
                permissions
            ):  # If the node was found, but the HTTP method wasn't, fall through to search by path pattern
                if permissions[0].startswith("issues/pull-requests"):
                    ...
                    if id == "issue_number":
                        ...
                        response = requests.get(
                            url,
                            headers={"Authorization": "Bearer %s" % ctx.options.token},
                        )
                        self.log_debug("get_permission response: %s" % response)
                        if response.status_code == 200:
        ...
        if len(path_segments) >= 5:
            if path_segments[1] == "repos" and path_segments[4] == "actions":
                if method == "GET" and self.is_public_repo(
                    f"{path_segments[2]}/{path_segments[3]}"
                ):
                    return []
                ...
                if method == "GET" and self.is_public_repo(
                    ...
                    return []
                return [("actions", "read" if method == "GET" else "write")]
            elif path_segments[1] == "repos" and (
                path_segments[4] == "check-runs" or path_segments[4] == "check-suites"
            ):
                return [("checks", "read" if method == "GET" else "write")]
            elif path_segments[1] == "repos" and (
                path_segments[4] == "releases"
                or path_segments[4] == "git"
                or path_segments[4] == "commits"
            ):
                if method == "GET" and self.is_public_repo(
                    f"{path_segments[2]}/{path_segments[3]}"
                ):
            ...
            # TODO: only GraphQL API for discussions?
                ...
                (path_segments[1] == "orgs" or path_segments[1] == "users")
                and path_segments[3] == "packages"
            ) or (path_segments[1] == "user" and path_segments[2] == "packages"):
            ...
            elif path_segments[1] == "projects" or (
                path_segments[1] == "repos" and path_segments[4] == "projects"
            ):
        ...
        if len(path_segments) >= 4:
            if path_segments[1] == "repositories" and path_segments[3] == "actions":
                ...
                path_segments[1] == "repositories"
                and path_segments[3] == "environments"
            ):
                if method == "GET" and self.is_public_repo(path_segments[2]):
                    return []
                return [("actions", "read" if method == "GET" else "write")]
            elif path_segments[1] == "repositories" and (
                path_segments[3] == "check-runs" or path_segments[3] == "check-suites"
            ):
                return [("checks", "read" if method == "GET" else "write")]
            elif path_segments[1] == "repositories" and (
                path_segments[3] == "releases"
                or path_segments[3] == "git"
                or path_segments[3] == "commits"
            ):
                if method == "GET" and self.is_public_repo(path_segments[2]):
                    return []
                return [("contents", "read" if method == "GET" else "write")]
            elif (
                path_segments[1] == "repositories" and path_segments[3] == "deployments"
            ):
                return [("deployments", "read" if method == "GET" else "write")]
                ...
                path_segments[1] == "repositories"
                and path_segments[3] == "code-scanning"
            ):
                return [("security-events", "read" if method == "GET" else "write")]
            elif path_segments[1] == "repositories" and path_segments[3] == "statuses":
                return [("statuses", "read" if method == "GET" else "write")]
            elif (
                path_segments[1] == "repos"
                and method == "GET"
                and len(path_segments) == 4
            ):
                return (
                    []
                )  # it successfully returns the repository even with permissions: {}
            ...
            if (
                path_segments[1] == "repositories" or path_segments[1] == "users"
            ) and method == "GET":
    ...
    def configure(self, updates):
        ...
        if bool(ctx.options.ACTIONS_ID_TOKEN_REQUEST_URL):
            self.id_token_request_url = urlsplit(
                ctx.options.ACTIONS_ID_TOKEN_REQUEST_URL
            )
    ...
    def requestheaders(self, flow):
        try:
            ...
            self.log_debug(
                ...
                % (
                    flow.request.method,
                    flow.request.url.replace(url_parts.hostname, hostname),
                )
            )
            ...
            for k, v in flow.request.headers.items():
                if k.upper().strip().startswith("AUTHORIZATION"):
                    ...
                    if self.contains_token(v, ctx.options.token):
                        ...
                        if (
                            self.id_token_request_url
                            and flow.request.method == "GET"
                            and hostname == self.id_token_request_url.hostname.lower()
                            and url_parts.path.lower()
                            == self.id_token_request_url.path.lower()
                        ):
                            self.write_json(
                                [("id-token", "write")],
                                flow.request.method,
